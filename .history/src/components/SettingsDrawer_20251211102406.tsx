                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        {editingConfig?.models && editingConfig.models.length > 0 && (
                          <Popover open={isModelDropdownOpen} onOpenChange={setIsModelDropdownOpen}>
                            <PopoverTrigger asChild>
                              <Button variant="outline" size="sm">
                                Select from available <ChevronDown className="w-4 h-4 ml-1" />
                              </Button>
                            </PopoverTrigger>
                            <PopoverContent className="w-80">
                              <div className="space-y-2">
                                ...
                                <div className="max-h-40 overflow-y-auto space-y-1">
                                  {editingConfig.models.map((modelId) => (
                                    <div
                                      key={modelId}
                        ...
                        <div className="flex gap-1 flex-1">
                          ...
                          <Button
                            ...
                            disabled={!manualModelInput.trim() || selectedModels.includes(manualModelInput.trim())}
                          >
