        ...
        <div className="p-3 sm:p-4 space-y-4 sm:space-y-6 min-w-0">
          <div>
            <div className="flex items-center justify-between gap-2 mb-2 min-w-0">
              <h2 className="text-sm font-semibold uppercase text-muted-foreground tracking-wider truncate">Agents</h2>
                ...
                <Select onValueChange={id => {
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <SelectTrigger className="h-7 w-[100px] text-xs px-2 border-dashed">
          ...
          <div>
            <div className="grid grid-cols-[1fr,auto] items-center gap-2 mb-2 min-w-0">
              <h2 className="text-sm font-semibold uppercase text-muted-foreground tracking-wider truncate">Sessions</h2>
              <div className="flex items-center gap-1 flex-shrink-0">
                <Button
                  variant="ghost"
                  size="sm"
