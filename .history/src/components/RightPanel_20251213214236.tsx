...
export function RightPanel({ agents, messages, isProcessing, onRetrySummary, onAddObserverMessage, onDismissObserverMessage, onInsertObserverMessageToInput, observerShortcuts }: RightPanelProps) {
