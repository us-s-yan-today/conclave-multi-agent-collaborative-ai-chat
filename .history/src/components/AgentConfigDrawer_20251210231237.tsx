                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="flex gap-2">
                      <Input
                        ...
                        placeholder="AIz..."
                        className={`flex-1 ${!isApiConfigValid && currentAgent.apiConfig.apiKey ? "border-yellow-400" : isApiValidated ? "border-green-400" : ""}`}
                      />
                      <Button
                        type="button"
                        variant="outline"
                    ...
                    {!isApiConfigValid && currentAgent.apiConfig.apiKey && !isApiValidated && (
