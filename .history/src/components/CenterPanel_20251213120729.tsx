          ...
          {isMobile && (
            <Sheet>
              ...
              <SheetContent side="left" className="p-0 w-full max-w-xs">
                <LeftPanel agents={agents} setAgents={setAgents} sessions={sessions} currentSessionId={currentSessionId} onNewSession={onNewSession} onSwitchSession={onSwitchSession} onDeleteSession={onDeleteSession} onEditAgent={onEditAgent} onPromoteAgent={onPromoteAgent} onExportSession={onExportSession} />
              </SheetContent>
            </Sheet>
          )}
