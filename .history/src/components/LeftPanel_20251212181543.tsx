        ...
        <div className="p-3 sm:p-4 space-y-4 sm:space-y-6">
          ...
          <div>
            <div className="flex items-center mb-2 gap-2">
              <h2 className="text-sm font-semibold uppercase text-muted-foreground tracking-wider flex-shrink">Sessions</h2>
              <Button
                variant="ghost"
                size="sm"
                className="h-7 px-2 text-xs border-dashed border flex-shrink-0 ml-auto whitespace-nowrap"
