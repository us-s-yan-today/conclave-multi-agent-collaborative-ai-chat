                  ...
                  <Card key={msg.id} className="p-4">
                    ...
                    <div className="flex gap-2 mt-4">
                      <Button
                        ...
                        onClick={() => {
                          if (agent) {
                            onAddToChat(agent.id, msg.id);
                            // Close drawer after adding to chat
                            onClose();
                          }
                        }}
                      >
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (agent) {
                            onDismiss(agent.id, msg.id);
                            // If no more messages, close drawer
                            if (agent.pendingMessages && agent.pendingMessages.length <= 1) {
                              onClose();
                            }
                          }
                        }}
