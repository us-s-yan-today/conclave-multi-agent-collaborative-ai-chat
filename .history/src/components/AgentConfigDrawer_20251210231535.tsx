...
export function AgentConfigDrawer({ agent, isOpen, onClose, onSave }: AgentConfigDrawerProps) {
  ...
  const handleValidateApiKey = async () => {
    ...
    try {
      ...
      const defaultEndpoint = '/v1/models/{model}:generateContent';
      
      const configToValidate = {
        ...currentAgent.apiConfig,
        baseURL: currentAgent.apiConfig.baseURL || defaultBaseURL,
        endpoint: currentAgent.apiConfig.endpoint || defaultEndpoint
      };
