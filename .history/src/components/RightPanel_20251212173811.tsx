      ...
      <Tabs defaultValue="status" className="flex-1 flex flex-col min-h-0">
        ...
        <TabsContent value="status" className="flex-1 flex flex-col gap-4 min-h-0 mt-4">
          ...
          <Card className="flex-1 flex flex-col min-h-0">
            ...
            <CardContent className="flex-1 flex flex-col gap-4 min-h-0 text-sm overflow-hidden">
              <div className="flex-1 flex flex-col min-h-0">
                <h3 className="font-semibold mb-2">Live Summary</h3>
                <ScrollArea className="flex-1 min-h-[100px] bg-muted/50 rounded-md p-3 text-muted-foreground">
              ...
              <div className="flex-1 flex flex-col min-h-0">
                ...
                {actionItems.length > 0 ? (
                  <ScrollArea className="flex-1 min-h-[100px] bg-muted/50 rounded-md p-3">
                    <div className="space-y-2">
