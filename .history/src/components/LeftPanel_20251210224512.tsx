...
export function LeftPanel({
  ...
  return (
    <aside className="h-full flex flex-col bg-card border rounded-lg min-w-0">
      ...
      <ScrollArea className="flex-1 min-h-0 scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent overflow-auto">
