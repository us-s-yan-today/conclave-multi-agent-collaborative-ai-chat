  ...
  return (
    <TooltipProvider>
      <div className="h-screen w-screen bg-card text-foreground overflow-hidden">
        <ThemeToggle />
        <div className="w-full h-full max-w-none px-2 sm:px-4">
          <div className="py-2 h-full">
            <div className="grid grid-cols-1 md:grid-cols-[280px,1fr,320px] lg:grid-cols-[320px,1fr,380px] xl:grid-cols-[360px,1fr,420px] h-full gap-2 sm:gap-4">
              {!isMobile && (
                <LeftPanel
                  agents={agents}
                  setAgents={setAgents}
