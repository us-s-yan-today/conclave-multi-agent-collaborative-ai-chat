...
export class GeminiProvider implements AIProvider {
  ...
  async processMessage(
    ...
    console.log('=== GeminiProvider.processMessage CALLED ===');
    console.log('Message:', message?.substring(0, 100));
    console.log('History length:', history?.length);
    console.log('Model:', model);
    console.log('SystemPrompt:', systemPrompt ? `YES (${systemPrompt.substring(0, 50)}...)` : 'NO');
    console.log('Personality:', personality ? `YES (${personality.substring(0, 50)}...)` : 'NO');
