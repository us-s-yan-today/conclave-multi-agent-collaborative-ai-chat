...
export type AgentRole = 'Primary' | 'Observer' | 'Summarizer';
export type AgentStatus = 'Ready' | 'Thinking' | 'Paused' | 'Has Feedback' | 'Hand Raised';
export type AgentSeverity = 'NONE' | 'MINOR' | 'IMPORTANT' | 'CRITICAL';
...
export interface Agent {
  ...
  systemPrompt?: string;
  status: AgentStatus;
  severity?: AgentSeverity; // Parsed from SEVERITY: line in observer response
  isActive: boolean;
  role: AgentRole;
  model: string;
